...
public class ReferenceTest {
    ...
    public void testCast() {
        Reference<Object> reference = new Reference<Object>("Object");
        assertSame(reference, reference.<Object>cast(Object.class));
    }

    @Test
    public void testEquals() {
        assertFalse((new Reference<Object>("Object")).equals("Obj"));
        assertFalse((new Reference<Object>(null)).equals(0));
    }

    @Test
    public void testEquals2() {
        Reference<Object> reference = new Reference<Object>("Object");
        assertTrue(reference.equals(new Reference<Object>("Object")));
    }
}
