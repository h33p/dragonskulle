 ...
 *   <li>Trigger the {@link Scroll#DOWN} button (which can be used to trigger {@link Action}s).
 *   <li>Be accessed as a raw value.
 * </ul>
 *
...
public class Scroll {
     ...
     * presses for either scrolling up or down.
     */
    private class ScrollListener extends GLFWScrollCallback {
        ...
        public void invoke(long window, double xOffset, double yOffset) {
            ...
            // Allows for scrolling to be treated as a button press, which can then be binded
            // Actions.
            if (yOffset > 0) {
