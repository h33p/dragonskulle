...
public class Player extends NetworkableComponent implements IOnStart, IFixedUpdate {
    ...
    private boolean buildAttempt(HexagonTile tile, BuildingDescriptor descriptor) {
        ...
        log.warning(
                "ATTack Stats on building to be added: "
                        + building.getAttack()); // NOT DOING THA THING
        log.warning(
                "dEF Stats on building to be added: "
                        + building.getDefence()); // NOT DOING THA THING
        log.warning(
                "TGEN Stats on building to be added: "
                        + building.getTokenGeneration()); // NOT DOING THA THING
