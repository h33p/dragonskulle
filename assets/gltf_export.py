...
try:
    ...
    bpy.ops.export_scene.gltf(export_format='GLTF_SEPARATE', filepath=out_path, export_texture_dir=tex_dir, export_cameras=True, export_extras=True, export_yup=False, export_lights=True)
