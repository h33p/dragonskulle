...
public class NetworkableComponent extends Component implements Serializable {
    ...
    void connectSyncVars() {
        ...
        System.out.println(
                "Need to actually link up"); // TODO component should create a network object which
        // this can talk to so i can store my vars there
    ...
    //        int sync_vars_vector_offset = RegisterSyncVarsRequest.createSyncVarsVector(builder,
    // sync_vars);
    ...
    //
    //        int message_offset = Message.createMessage(builder,
    // VariableMessage.RegisterSyncVarsRequest, request_offset);
