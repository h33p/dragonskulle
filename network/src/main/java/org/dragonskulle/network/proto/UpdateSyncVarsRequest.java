...
public final class UpdateSyncVarsRequest extends Table {
    ...
    public static UpdateSyncVarsRequest getRootAsUpdateSyncVarsRequest(ByteBuffer _bb) {
        return getRootAsUpdateSyncVarsRequest(_bb, new UpdateSyncVarsRequest());
    }

    public static UpdateSyncVarsRequest getRootAsUpdateSyncVarsRequest(
            ByteBuffer _bb, UpdateSyncVarsRequest obj) {
    ...
    public UpdateSyncVarsRequest __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public static int createUpdateSyncVarsRequest(
            FlatBufferBuilder builder, int netIdOffset, int sync_varOffset) {
    ...
    public static void startUpdateSyncVarsRequest(FlatBufferBuilder builder) {
        builder.startTable(2);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public UpdateSyncVarsRequest get(int j) {
            return get(new UpdateSyncVarsRequest(), j);
        }

        public UpdateSyncVarsRequest get(UpdateSyncVarsRequest obj, int j) {
